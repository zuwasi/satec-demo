 ...
 */
#define IP_PREFETCH_TIME_US       (0x0120)
/**
 ...
 */
#define IP_PREFETCHABORT_TIME_US  (0x01df) 
...
#define RW_BT40_VERSION                      (BT40_VERSION)
#define RW_BT41_VERSION                      (BT41_VERSION)
#define RW_BT42_VERSION                      (BT42_VERSION)
#define RW_BT50_VERSION                      (BT50_VERSION)
#define RW_BT51_VERSION                      (BT51_VERSION)
#define RW_BT52_VERSION                      (BT52_VERSION)
...
enum KE_TASK_TYPE
{
    ...
    #if (BLE_GAF_PRESENT)
    TASK_GAF_FIRST,
    TASK_IAP = TASK_GAF_FIRST,       // Isochronous Access Profile Task
    TASK_ACC = TASK_IAP + 1,
    TASK_ASC,
    TASK_BAP,
    TASK_ARC,
...
#define RWIP_MINIMUM_SLEEP_TIME                (3)

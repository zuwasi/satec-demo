...
#define ATT_128_CHAR_USER_DESCRIPTION     ATT_16_TO_128_ARRAY(GATT_DESC_CHAR_USER_DESCRIPTION)
 ...
 * @param[in]     info         info (@see enum gatt_svc_info_bf)
 ...
 ****************************************************************************************
 */
typedef uint16_t (*prf_init_cb) (prf_data_t* p_env, uint16_t* p_start_hdl, uint8_t info, uint8_t user_prio,
